...
const { interaction: initialStatusInteraction, prophecy, version: intialStatusVersion, interactionWithoutState } = require('../prophecies/sporteventstatus/contract');
...
describe('Define pact with propefy', () => {
    ...
    describe('when a request for data is made and I want something else saved', () => {
        ...
        it('second test', () => {
            provider.addInteraction(interactionWithoutState);
            // Define the base URL to the Pact mock server
            return provider.executeTest(async () => {
    ...
    afterAll(() => pactPublisher(intialStatusVersion));
