...
const interactionWithoutState = {
    given: 'some-given-value',
    ...
    willRespondWith: {
        status: 200,
        body: MatchersV3.like({
            "subject": MatchersV3.equal("second interaction"),
            "prophecy": [
                {
                    "t": MatchersV3.equal(1704304680000),
                    "v": {
...
module.exports = { prophecy, interaction, interactionWithoutState, version };
